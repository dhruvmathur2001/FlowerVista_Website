    ...
    <>
      <header className="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-4 px-5 bg-light">
        ...
        <div className="col-md-1 text-end">
          <a href="#" className="cc"><FaCartShopping size={25} className="icon-large" /></a>
        </div>
      ...
      <div className="container-fluid py-2 nav-bg navbt">
        <ul className="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
          <li>
            <Link to="/" className="nav-link nav-size px-2 mx-md-2 text-light link-hover">
              Home
            </Link>
          </li>
          <li>
            <a href="#ABOUT" className="nav-link nav-size px-2 mx-md-2 text-light link-hover">
              About Us
            </a>
          </li>
          <li>
            <a href="#PRODUCTS" className="nav-link nav-size px-2 mx-md-2 text-light link-hover">
              Products
            </a>
          </li>
          <li>
            <a href="#REVIEWS" className="nav-link nav-size px-2 mx-md-2 text-light link-hover">
              Reviews
            </a>
          </li>
        </ul>
